...
<?php Pjax::begin(); ?>
    ...
    <?= GridView::widget([
     ...
     'panel' => [
        ...
        'type' => 'primary',
        'before' => '<p></p><div style="padding-top: 7px;"><em>'.$infoh.'</em></div> '.$infoid.'</p>',
            ],
    'toolbar' =>  [
//        '{export}',
//        '{toggleData}'
...
<div class="btn-group" role="group" aria-label="Post data">
    ...
    <?= Html::submitButton('Esporta  report', ['class' => 'btn btn-primary esporta', 'name' => 'submit', 'value' => 'esporta-report',]) ?>
...
<?= Html::submitButton('Chiudi Sessione ', ['class' => 'btn btn-primary chiudi', 'name' => 'submit', 'value' => 'chiudisessionepranzo',
...
<!--    --><?php //= Html::submitButton('Chiudi Sessione Colazione', ['class' => 'btn btn-primary chiudi', 'name' => 'submit', 'value' => 'chiudisessionecolazione',
//        "onclick" => 'if(confirm("Sei sicuro di voler chiudere la sessione del giorno?")){
//                     return true;
//                    }else{
//                     return false;
